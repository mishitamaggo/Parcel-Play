...
export function renderPackagingCalculator(container, onOrderQuote) {
  ...
  const FORMATS = [
    ...
    { id: 'molded-pulp', name: 'Molded Cellulose Tray', base: 125.00, minMoq: 1000, time: '14-18 Days', desc: 'Zero-plastic sugarcane & bamboo' }
  ];

  const SUBSTRATES = [
    { id: 'obsidian-450', name: 'Obsidian Velvet (450 GSM)', priceMod: 38.00 },
    { id: 'virgin-cotton-600', name: 'Virgin Cotton Uncoated (600 GSM)', priceMod: 48.00 },
    { id: 'raw-kraft-350', name: 'Raw Unbleached Kraft (350 GSM)', priceMod: 18.00 },
  ...
  const FINISH_OPTIONS = [
    ...
    { id: 'foil-tape', name: 'Reinforced Copper Sealing Tape', cost: 24.00 }
  ];
